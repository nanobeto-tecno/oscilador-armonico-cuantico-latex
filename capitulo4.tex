...
Actualmente, la principal limitación que se encuentra en las computadoras cuánticas es la fragilidad de los estados cuánticos frente al ruido y la decoherencia. En las arquitecturas basadas en qubits de dos niveles, la corrección de errores requiere una gran cantidad de qubits físicos para codificar un qubit lógico, lo que supone un problema en cuanto a escalabilidad experimental. En este contexto, los códigos bosónicos surgen como una alternativa con potencial, ya que explotan directamente la estructura del oscilador armónico cuántico como espacio de codificación.

Con este enfoque, los códigos bosónicos aprovechan el espacio de Hibert infinito de un solo modo bosónico para redundar información. \cite{cai2021bosonic} lo describen como:  
"En comparación con los qubits, los osciladores armónicos o modos bosónicos         proporcionan una ruta alternativa hacia la computación cuántica universal. Los modos bosónicos son beneficiosos para el procesamiento de información cuántica en cuatro aspectos. Primero, un solo modo bosónico puede proporcionar un espacio de Hilbert infinitamente grande , que permite la codificación QEC simplemente extendiendo los números de excitación mientras se mantienen fijos los canales de ruido . Segundo, los modos bosónicos se pueden realizar con múltiples grados de libertad, por ejemplo, espacio, tiempo, frecuencia, polarización o sus combinaciones, y por lo tanto son escalables. Tercero, los modos bosónicos son convenientes para transferir información y también pueden interactuar fácilmente con muchos sistemas físicos diferentes, por lo tanto, son bloques de construcción inevitables en las redes cuánticas. Por último, los modos bosónicos son sistemas físicos fundamentales e indispensables que no pueden ser reemplazados por otros qubits o sistemas cuánticos de nivel finito. "

La transición de qubits ruidosos a computadoras cuánticas eficientes se divide en tres etapas, en donde los códigos bosónicos son la piedra angular de los mismos. En la primera fase, se busca alcanzar la perfección en un solo qubit. Como demuestran \cite{campagne2020quantum} Campagne-Ibarcq et al. (2020) en su protocolo de estabilización de estados GKP, el principal problema es la propagación de errores desde el qubit ancilla hacia el qubit lógico durante la medición de paridad. El trabajo que sigue se concentrará en mejorar la coherencia del ancilla y el oscilador para aumentar la vida útil del qubit lógico. Ya en la segunda fase, el eje es encontrar la integración entre cúbits lógicos. Tal como se describe en el roadmap de Alice & Bob \cite{alice2024roadmap}, para el 2030 se buscará un control de microondas multiplexado y escalable, en donde se puedan ejecutar compuertas lógicas entre qubits vecinos sin que se vea afectada la coherencia. Esto supondrá el primer procesador que demuestre una verdadera ventaja cuántica en tareas de corrección de errores de fase. En la tercera fase se plantean las computadoras cuánticas resistentes a fallos a gran escala. En el roadmap de Alice & Bob, se comprometen a que para el año 2030, se lanzará Graphene, una computadora cuántica universal y tolerante a fallos, diseñada para resolver problemas del mundo real, ya que permitirá ejecutar algoritmos a gran escala. Esto beneficiará a áreas como finanzas, ciencias de materiales, machine learning, medicina, entre otras.