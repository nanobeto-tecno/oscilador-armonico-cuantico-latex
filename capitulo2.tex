...
\begin{equation}
	\hat{H}\psi = E\psi
\end{equation}donde $\hat{H}$ es el operador hamiltoniano y $E$ corresponde al valor propio de energía asociado al estado $\psi$ \citep{schrodinger1926a, schrodinger1926b}. Para el oscilador armónico \citep{schrodinger1926a} esto tiene una consecuencia directa: la exigencia de soluciones normalizables de la ecuación de Schrödinger implica que la función de onda $\psi(x)$ represente una probabilidad total igual a uno. Bajo estas condiciones, las 
soluciones físicamente aceptables conducen a un espectro discreto de energías \citep{schrodinger1926a, schrodinger1926b}. Ya no hacía falta suponer la cuantización como hizo \cite{planck1901}, ahora salía directamente de las matemáticas. \cite{ehrenfest1927} mostró además cómo recuperar el comportamiento clásico como un caso límite de estas ecuaciones.
...
\cite{dirac1927} dio el paso conceptual más importante al extender el principio de cuantización al propio campo electromagnético. En este enfoque, el campo puede describirse como un conjunto de modos normales equivalentes a osciladores armónicos cuánticos. De este modo, \cite{dirac1927} logró explicar de manera natural procesos como la emisión y absorción de radiación sin recurrir a postulados adicionales. La formalización sistemática de este enfoque quedó posteriormente consolidada en su tratado \citep{dirac1930}.
